...
data_path = '/run/media/cptlab/qaqc_data/results/QAQC_SM/qaqc-gui_output/SM_QAQC_Production'
selections = []
plotDir = '/data/QAQC_SM/qaqc-gui_output/scale_calibration_plots_sodium/'                                                                                                                                  
gui_settings_path = data_path 
...
inputFiles = glob.glob(data_path+'/**/*_analysis.root')
...
for key in modules:
    ...
    if int(module)<32110020008695:continue #for sodium-only calibrations
    accept = 1
